...
- Docker installed
- Fork the https://github.com/shawncl/devsecops-jenkins-scanner [repository](https://github.com/shawncl/devsecops-jenkins-scanner) under your GitHub account, as you will need to make changes to the repository. Shortenurl - https://bit.ly/apr26
...
4. Modify the repository name: `find . -type f -exec sed -i "s/shawncl/$YOURID/g" {} +`
...
```py
        ...
        codebuild_behave_image_build = codebuild.Project(
            ...
            source=codebuild.Source.git_hub(
                owner="shawncl", repo="devsecops-jenkins-scanner", branch_or_ref=branch_or_ref
            ),
